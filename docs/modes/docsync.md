...
- **Verified layer** (`.mathema/verified/<key>.yaml`): machine-written
  ...
  an [integrity checksum](../governance.md#the-integrity-checksum)
  over each claim's statement, verdict and acceptance, and over the
  retirement rows; a hand-edit is
