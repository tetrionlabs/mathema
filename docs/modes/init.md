...
| `--root` | project root to write `.gitattributes`, `.mathema/.gitignore`, and `claims/` under (default: the nearest ancestor holding `.mathema/`, else the enclosing git repository, else `.`) |
