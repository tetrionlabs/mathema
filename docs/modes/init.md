...
| `--root` | project root to write `.gitattributes`, `.mathema/.gitignore`, and `claims/` under (default `.`) |
...
| `--agents-ref` | branch or tag of the skills repo to fetch (default its default branch); pin to match your mathema line |
